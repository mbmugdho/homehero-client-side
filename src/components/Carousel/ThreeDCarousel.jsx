...
function ServiceCard({ title, desc, to, icon }) {
  return (
    <div
      className="card w-64 h-44 p-4 bg-white/10 backdrop-blur border border-white/15 text-white shadow-xl
                 hover:-translate-y-1 transition [backface-visibility:hidden]"
    >
      ...
      <div className="mt-4">
        <Link to={to} className="cosmic-btn text-sm px-4 py-2 inline-flex">Explore</Link>
      </div>
    </div>
  );
}
