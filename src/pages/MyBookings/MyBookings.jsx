    ...
    <section className="container-x py-12">
      ...
      {userBookings.length === 0 ? (
        ...
        <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {userBookings.map(b => (
            <div key={b.orderId || b.id} className="card bg-white/10 border border-white/15 text-white shadow-xl">
              ...
              <div className="p-4">
                ...
                <div className="text-white/80 text-sm mt-1">${b.hourly_rate}/hr • {b.duration}</div>
              </div>
            </div>
          ))}
        </div>
